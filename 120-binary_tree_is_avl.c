...
/**
 * is_avl_helper - function check if a binary tree is a valid AVL tree.
 * @tree: points to the root node of the tree being checked.
...
/**
 * binary_tree_is_avl - function to check if a binary tree is a valid AVL tree.
 * @tree: points to the root node of the tree being checked.
 *
