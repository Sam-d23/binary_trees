...
/**
 * tree_size_h - the sum of heights of a binary tree is measured
 * @tree: points to the root node of the tree
 * whose height is to be measured
 * Return: Height (success), 0 (failure)
 */
...
/**
 * _preorder - pre-order traversal of a binary tree
 * @tree: pointer to the root node of the tree to traverse
 * @node: thee last node to be traversed
...
/**
 * heapify - shows max binary heap
 * @root: points to the binary heap
 */
...
/**
 * heap_extract - the root node is extracted from a Max Binary Heap
 * @root: pointer to the root of the heap
 * Return: extracted node's value
 **/
